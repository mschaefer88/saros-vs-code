...
public class IntelliJReferencePointManager {
   ...
   */
  public static @NotNull IReferencePoint create(@NotNull Module module) {
   ...
   */
  public static @NotNull IReferencePoint create(@NotNull VirtualFile virtualFile) {
   ...
   */
  public @NotNull Module getModule(@NotNull IReferencePoint referencePoint) {
   ...
   *     exists a module or the {@link IPath} relative path is null
   */
   ...
   *     exists a module or the {@link IPath} relative path is null
   */
  public @NotNull IResource getSarosResource(
      @NotNull IReferencePoint referencePoint, @NotNull IPath referencePointRelativePath) {
    Module module = getModule(referencePoint);

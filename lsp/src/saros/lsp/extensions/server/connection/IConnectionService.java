 ...
 * everything contact related.
 */
@JsonSegment("saros/connection")
public interface IConnectionService {

  /**
   * Connects to the XMPP server with the account
  ...
  /**
   * Gets the current connection state to the XMPP
   * server.
   * 
   * @return <i>true</i> if connection is active, <i>false</i>
   * otherwise
   */
  @JsonRequest

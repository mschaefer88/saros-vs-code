...
/** Interface of the session service that is responsible for everything session related. */
@JsonSegment("saros/session")
public interface ISessionService {

  /**
   * Invites a contact to the currently active session and starts one if currently none is active.
   *

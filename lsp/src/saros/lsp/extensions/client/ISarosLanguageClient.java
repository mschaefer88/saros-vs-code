...
public interface ISarosLanguageClient extends LanguageClient {
  ...
  /**
   * Sends a notification that informs the client
   * about a state change of the session, ie. if it's
   * active or not.
   * 
  ...
  /**
   * Sends a notification that informs the client
   * about a state change of the XMPP connection, ie.
  ...
  /**
   * Sends a notification that informs the client
   * about a state change of a contact, eg. online
  ...
  /**
   * Sends a notification that issues the client
   * to open an editor with the file contents.
   * 
  ...
  /**
   * Sends a notification to the client that annotations
   * have changed.
   * 
  ...
  /**
   * Sends a notification to the client that a user has
  ...
  /**
   * Sends a notification to the client that the state
  ...
  /**
   * Sends a notification to the client that a user
  ...
  /**
   * Sends a request to the client to inform
   * it about a new progress operation.
   * 
  ...
  /**
   * Sends a notification to the client to
   * inform it about progress changes.
   * @param <T>
   * @param params
   */

...
public class NegotiationHandler implements INegotiationHandler {
  ...
  public NegotiationHandler(
            ...
            final UIInteractionManager interactionManager, final XMPPContactsService contactService){
    ...
    private boolean AskAcceptInvite(JID inviteeJid) {
      ...
      String inviteeName = invitingContact.isPresent() ? invitingContact.get().getDisplayableName() : inviteeJid.getName();

      return this.interactionManager.getUserInputYesNo(String.format("'%s' invited you to a session", inviteeName), "Accept?");
    }

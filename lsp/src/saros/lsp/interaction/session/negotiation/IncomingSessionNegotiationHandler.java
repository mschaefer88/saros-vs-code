...
public class IncomingSessionNegotiationHandler {
    ...
    public IncomingSessionNegotiationHandler(final XMPPContactsService contactService,
            final ISarosLanguageClient client, final UIInteractionManager interactionManager) {
            ...
            switch (status) {
              ...
              case ERROR:
                this.sendNotification(
                    negotiation.getErrorMessage() + " at remote: " + negotiation.getPeer(), MessageType.Error);
                break;
              case REMOTE_CANCEL:
              case REMOTE_ERROR:
              this.sendNotification(
                    "Session negotiation was cancelled by remote: "
                        + negotiation.getPeer().toString(), MessageType.Warning);
                break;
            }
          }
    }
